...
build_daemon() {
    ...
    declare -A plugin_libs=(
        ["falconstore"]="falconstore/libfalconstore.so"
...
launch_app() {
    ...
    export LD_LIBRARY_PATH="$LIB_DIR:$PLUGIN_DIR:$PLUGIN_DIR/falconstore:$PLUGIN_DIR/netfalcon:$PLUGIN_DIR/ironroot:$PLUGIN_DIR/zer0:${LD_LIBRARY_PATH:-}"
