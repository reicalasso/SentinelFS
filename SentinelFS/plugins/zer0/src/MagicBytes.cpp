...
void MagicBytes::initExtensionMap() {
    ...
    extensionMap_["py"] = FileCategory::TEXT;
    extensionMap_["pyw"] = FileCategory::TEXT;
    extensionMap_["pyi"] = FileCategory::TEXT;
    extensionMap_["pyx"] = FileCategory::TEXT;
    extensionMap_["rb"] = FileCategory::TEXT;
    extensionMap_["pl"] = FileCategory::TEXT;
    extensionMap_["pm"] = FileCategory::TEXT;
    extensionMap_["lua"] = FileCategory::TEXT;
    extensionMap_["sh"] = FileCategory::TEXT;
    extensionMap_["bash"] = FileCategory::TEXT;
    extensionMap_["zsh"] = FileCategory::TEXT;
    extensionMap_["fish"] = FileCategory::TEXT;
    extensionMap_["ps1"] = FileCategory::TEXT;
    extensionMap_["psm1"] = FileCategory::TEXT;
    extensionMap_["bat"] = FileCategory::TEXT;
    extensionMap_["cmd"] = FileCategory::TEXT;
    extensionMap_["r"] = FileCategory::TEXT;
    extensionMap_["R"] = FileCategory::TEXT;
    extensionMap_["jl"] = FileCategory::TEXT;
    extensionMap_["m"] = FileCategory::TEXT;
    extensionMap_["mm"] = FileCategory::TEXT;
    extensionMap_["groovy"] = FileCategory::TEXT;
    extensionMap_["gradle"] = FileCategory::TEXT;
    extensionMap_["cmake"] = FileCategory::TEXT;
    extensionMap_["make"] = FileCategory::TEXT;
    extensionMap_["mk"] = FileCategory::TEXT;
    extensionMap_["yaml"] = FileCategory::TEXT;
    extensionMap_["yml"] = FileCategory::TEXT;
    extensionMap_["toml"] = FileCategory::TEXT;
    extensionMap_["ini"] = FileCategory::TEXT;
    extensionMap_["conf"] = FileCategory::TEXT;
    extensionMap_["cfg"] = FileCategory::TEXT;
    extensionMap_["json"] = FileCategory::TEXT;
    extensionMap_["xml"] = FileCategory::TEXT;
    extensionMap_["xsl"] = FileCategory::TEXT;
    extensionMap_["xslt"] = FileCategory::TEXT;
    extensionMap_["svg"] = FileCategory::TEXT;  // SVG is XML-based text
    extensionMap_["md"] = FileCategory::TEXT;
    extensionMap_["markdown"] = FileCategory::TEXT;
    extensionMap_["rst"] = FileCategory::TEXT;
    extensionMap_["tex"] = FileCategory::TEXT;
    extensionMap_["latex"] = FileCategory::TEXT;
    extensionMap_["log"] = FileCategory::TEXT;
    extensionMap_["csv"] = FileCategory::TEXT;
    extensionMap_["tsv"] = FileCategory::TEXT;
    extensionMap_["diff"] = FileCategory::TEXT;
    extensionMap_["patch"] = FileCategory::TEXT;
    extensionMap_["gitignore"] = FileCategory::TEXT;
    extensionMap_["dockerignore"] = FileCategory::TEXT;
    extensionMap_["editorconfig"] = FileCategory::TEXT;
    extensionMap_["env"] = FileCategory::TEXT;
    extensionMap_["properties"] = FileCategory::TEXT;
}
